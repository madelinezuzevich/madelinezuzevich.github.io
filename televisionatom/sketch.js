...
let ctrls = {
    ...
    seafloor:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDJBOJhWwS5STJnB6d0fawS9PO_Hl0xvEjWA&usqp=CAU",
    clr1: {r:0, g:255, b:255}, //color 1
    clr2:{ r:0, g:255, b:127}, //color 2
    d_range: {min: 2, max:6}, //range of sphere diameters
    explode_factor: .2, //explode distance
    light_intensity:1
